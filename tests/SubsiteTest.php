...
class SubsiteTest extends BaseSubsiteTest
{
    ...
    {
        $member1Sites = Subsite::accessible_sites("CMS_ACCESS_CMSMain",
        ...
        $adminSites = Subsite::accessible_sites("CMS_ACCESS_CMSMain",
        ...
        $member2Sites = Subsite::accessible_sites("CMS_ACCESS_CMSMain",
