...
class SiteTreeExtension extends DataExtension
{
    ...
    private static $indexes = [
        'ClassNameSubsite' => ['ClassName', 'SubsiteID'],
        'ParentSubsite' => ['ParentID', 'SubsiteID'],
    ];
    ...
    */
    public function canEdit($member = null)
    {
        ...
        $goodSites = Subsite::accessible_sites_ids('SITETREE_EDIT_ALL', $member);
    ...
    public function duplicateToSubsitePrep($subsiteID)
    {
        ...
        if ($this->owner->Parent()) {
            ...
            $newParentPage = SiteTree::get()->filter('URLSegment', $parentSeg)->first();
            if ($newParentPage) {
